            ...
            if(  selection == 2 ) {
                ...
                joinMine.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        String url = "vispar.player://live/rooms/54.148.16.2/"+PlaceholderFragment.this.mUserName+"/"+PlaceholderFragment.this.mUserName+"/auto/false/";
                    	...
                    	builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
	                            public void onClick(DialogInterface dialog, int whichButton) {
	                                ...
	                                if( RegisterActivity.isUserNameValid(user.toString()) ) {
		                    			...
		                    			joinOthers.setVisibility(View.GONE);
		                    			Intent intent = new Intent(getActivity(), AirConfActivity.class);
		                                String url = "vispar.player://live/rooms/54.148.16.2/"+user+"/"+PlaceholderFragment.this.mUserName+"/auto/false/";
		                                Uri data = Uri.parse(url);
		                                intent.setData(data);
		                                startActivity(intent);
	                                } else {

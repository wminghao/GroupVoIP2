...
long runTest(FILE* fd1, FILE* fd2, FILE* fd3, FILE* fd4, FILE* fd5, FILE* fd6, FILE* fd7)
{
    ...
    while(!(bFile1Done && bFile2Done && bFile3Done && bFile4Done & bFile5Done & bFile6Done & bFile7Done)) {
...
int main( int argc, char** argv ) {
  if ( argc != 8 ) {
      fprintf(stderr, "usage: %s input_file1 input_file2 input_file3 input_file4 input_file5 input_file6 input_file7", argv[0]);
      return -1;
  } 
  //////////////////
  FILE *fp1;
  ...
  ///////////////
  runTest( fp1, fp2, fp3, fp4, fp5, fp6, fp7);
  return 0;
}
